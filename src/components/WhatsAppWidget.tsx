      ...
      {visible && (
        ...
        >
          <button
            ...
            className="group relative flex items-center justify-center w-14 h-14 rounded-full shadow-xl focus:outline-none focus-visible:ring-2 focus-visible:ring-green-400"
            style={{ background: "#25D366" }}
          >
            {/* Pulse ring — disabled if prefers-reduced-motion */}
            {!prefersReduced && (
              <span
