  ...
  return (
    ...
    >
      {logoUrl ? (
        ...
        <div className={`${s.wrap} bg-gradient-to-tr from-[#006224] to-[#ecc246] text-white shadow-md shadow-emerald-950/20 ${onClick ? "group-hover:scale-105 transition-transform duration-300" : ""}`}>
          <Sprout className={s.icon} />
        </div>
      )}
      <span className={`font-sans font-bold ${s.text} tracking-tight ${theme === "dark" ? "text-white" : "text-stone-900"} ${onClick ? "group-hover:text-[#ecc246] transition-colors duration-300" : ""}`}>
